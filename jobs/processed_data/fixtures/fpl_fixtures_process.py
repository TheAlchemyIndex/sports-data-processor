...
def transform_data(fixtures_df, teams_df):
    ...
    fixtures_with_home_team_names_df = (
        fixtures_df.join(teams_df,
                         (fixtures_df["team_h"] == teams_df["id"]) & (fixtures_df["season"] == teams_df["season"])
                         , how="inner")
    ...
    fixtures_with_away_team_names_df = (
        fixtures_with_home_team_names_df.join(teams_df,
                         (fixtures_with_home_team_names_df["team_a"] == teams_df["id"]) & (fixtures_with_home_team_names_df["season"] == teams_df["season"])
                         , how="inner")
