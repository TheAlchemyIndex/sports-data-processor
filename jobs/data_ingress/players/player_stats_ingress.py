...
JOB_NAME = "player_stats_ingress"
OUTPUT_PATH = f"C:/repos/sports-data-processor/data/football/raw-ingress/players/stats"
...
def extract_data(spark):
    ...
    players_names_df = (
        spark.read.format("parquet")
        .load("C:/repos/sports-data-processor/data/football/raw-ingress/players/names")
